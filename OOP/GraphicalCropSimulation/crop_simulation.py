from OOP.GraphicalCropSimulation.crop_view_class import WheatView, PotatoView
from OOP.GraphicalCropSimulation.manual_grow_dialog_class import ManualGrowDialog
from OOP.GraphicalCropSimulation.radio_button_widget import RadioButtonWidget
from OOP.potato_class import Potato
from OOP.wheat_class import Wheat
...
class CropWindow(QMainWindow):
    ...
    def create_select_crop_layout(self):
        ...
        self.crop_radio_buttons = RadioButtonWidget("Crop Simulation", "Please select a crop",
                                                    ("Wheat", "Potato"))  # create crop selector
